...
- 아이 개월 수 계산
- 부모·자녀 나이 관계 계산
- 미니게임(숫자 맞추기, 스네이크, 틱택토, 가위바위보, 님, 퐁, 행맨, 메모리 매치, 커넥트4, 라이츠아웃, 지뢰찾기, 사이먼)
- 블로그 목록/상세/페이징
...
- `/minigames/nim` 님
- `/minigames/pong` 퐁
- `/minigames/hangman` 행맨
- `/minigames/memory` 메모리 매치
- `/minigames/connect4` 커넥트4
- `/minigames/lightsout` 라이츠아웃
- `/minigames/minesweeper` 지뢰찾기
- `/minigames/simon` 사이먼
- `/health` 헬스체크
