...
LEGACY_ARTICLE_METADATA = {
    "2026-man-age-guide": article_metadata(
        ...
        sources=[_source("국가법령정보센터", "민법 제158조 나이의 계산과 표시", "https://www.law.go.kr/법령/민법/제158조")],
    ...
    "early-birth-school-grade-guide": article_metadata(
        ...
        sources=[
            _source("국가법령정보센터", "초·중등교육법 제13조 취학 의무", "https://www.law.go.kr/법령/초·중등교육법/제13조"),
            _source("정부24", "취학통지서 관련 FAQ", "https://www.gov.kr/portal/ntcItm/81124"),
        ],
    ...
    "baby-months-calculation-guide": article_metadata(
        ...
        sources=[_source("국민건강보험공단", "건강검진 실시기준의 영유아건강검진 시기", "https://www.nhis.or.kr/lm/lmxsrv/law/lawFullContent.do?SEQ=80&SEQ_HISTORY=595068")],
    ...
    completed["2026-man-age-guide"]["content_sections"] = [
        ...
        },
        {
            ...
            "paragraphs": [
                ...
                "결과 화면에서 관련 계산기와 공식 출처로 이동해 확인을 이어 가세요. 이 글의 검수일과 만료일도 함께 보고, 이후 법령이나 기관 공고가 바뀌었다면 최신 공식 안내를 우선합니다.",
            ],
        },
    ]
    completed["birth-year-age-interpretation"]["content_sections"] = [
        {
            ...
            "paragraphs": [
                "같은 출생연도라도 올해 생일이 지난 사람과 아직 오지 않은 사람은 현재 만나이가 한 살 다릅니다. ‘1992년생은 몇 살’처럼 월일이 없는 질문에는 하나의 숫자 대신 생일 전후 두 값을 범위로 답해야 정확합니다.",
    ...
    completed["early-birth-school-grade-guide"]["content_sections"] = [
        {
            ...
            "paragraphs": [
                ...
                "처음 만난 사람의 호칭이나 현재 나이를 판단할 때 빠른년생 여부만으로 한 살을 더하거나 빼지 않습니다. 공식 나이는 생년월일 기준 만나이로, 학교 경험은 실제 입학연도와 학적으로 나누어 설명합니다.",
            ],
        },
        {
