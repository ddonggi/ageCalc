...
BLOG_ARTICLE_BLUEPRINTS = {
    ...
    "early-birth-school-grade-guide": {
        ...
        "direct_answer_paragraphs": [
            ...
            "학년 계산기와 입학년도 계산표를 함께 보면 두 기준을 정확히 구분할 수 있습니다.",
        ],
        "audience_items": [
    ...
    "baby-months-calculation-guide": {
        ...
        "hero_summary": "아이 월령은 생후 개월 수로 확인합니다. 기념일과 발달 안내를 볼 때도 같은 월령 기준을 사용하세요.",
        "eyebrow": "해설 글",
        ...
        "faq_items": [
            ...
            {"question": "어떤 도구를 같이 보면 좋나요?", "answer": "개월수 계산표와 100일 계산기를 함께 보면 기념 시점을 정리하기가 수월합니다."},
        ],
        "related_tools": [
